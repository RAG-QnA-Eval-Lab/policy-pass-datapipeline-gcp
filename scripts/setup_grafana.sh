#!/usr/bin/env bash
# MongoDB VM에 Node Exporter + Prometheus + Grafana 설치 및 구성.
#
...
echo "  대시보드      : http://$(hostname -I | awk '{print $1}'):3000/d/rag-youth-policy"
echo ""
