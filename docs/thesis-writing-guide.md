...
- GPT-4o 대비 비용 ~10-25배 절감, 평가 일관성 비율 실측
...
**독립변수**: Judge 모델 2종 (GPT-4o, GPT-4o-mini)
...
|-----------|---------------|-----------|---------------------|----------------|
| GPT-4o | ~$2.50~4.00 | ~2.5s | 1.0 (기준) | 0.0 (기준) |
...
- 1건당 ~1,500 input tokens (system prompt + context + question + answer) × 2회(position bias) = ~3,000 tokens
- 1건당 ~100 output tokens × 2회 = ~200 tokens
- 100쌍: GPT-4o = 300K input × $2.50/1M + 20K output × $10/1M = $0.75 + $0.20 = ~$0.95 (2회: ~$1.90)
- 100쌍: GPT-4o-mini = 300K × $0.15/1M + 20K × $0.60/1M = $0.045 + $0.012 = ~$0.06 (2회: ~$0.12)

**핵심 주장**: GPT-4o-mini는 GPT-4o 대비 ~15배 낮은 비용으로 Kendall τ 0.8 이상의 순위 일관성 달성.
...
- [ ] 동일 100쌍을 GPT-4o Judge로 재평가
- [ ] GPT-4o vs GPT-4o-mini: Kendall τ, MAE, Agreement Rate 계산
- [ ] 비용 산출 (API usage 기록)
